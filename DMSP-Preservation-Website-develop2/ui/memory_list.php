...
<body class="memory-list">
    ...
    <div class="hamburger">
        <button class="button-hamburger" type="button"><a href="menu.html"> <img src="../img/button/narv.png"
                    style="width: 4vw; background-color: transparent; " alt="" /></a>
        </button>
    </div>
    ...
    <div class="container" id="tablist-section">
        ...
        <div class="tab-content row scroll" id="nav-tabContent"
            style="max-height:35vw; overflow-y: auto; overflow-x: hidden;">
            ...
            <div class="tab-pane fade show active col-12 col-md-10  offset-md-1 " id="nav-childhood" role="tabpanel"
                ...
                <div class="row">
                    <div class="col-12 align-self-center" style="margin-left:1vw;">
    ...
    <div class="fixed-bottom">
        <a href="record_memory.html">
            <div class="center" style="width:34vw">
                <div class="col-12 align-self-center" style="margin:3vw 0 0 0">
                    <div class="svg-wrapper-light purple" style="width:100%; border: solid 0vw var(--cpurple);">
                        <div class="button-text-light" style="top:1vw; color:white">Add My
                            Memories</div>
                    </div>
                </div>
            </div>
